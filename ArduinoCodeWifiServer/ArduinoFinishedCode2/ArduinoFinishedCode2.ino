...
int LaserValue = 0;
int MotionValue = 0;
int LaserPin = 6; //This is motion information
int TripPin = 7; //This is Lights on/off information
int lightPin = 3;
int waterPin = 8;
...
boolean sendPage(char* URL) {
  ...
  //if the url did not change then don't change the page
  if (URL[1] == '?' && URL[2] == 'L' && URL[3] == 'E' && URL[4] == 'D') //The url starts with /
  {
 ...
 //Reads the input and converts it to Kelvin degrees
  temp_in_kelvin = analogRead(0) * 0.0048626817 * 100;
  ...
  //Temperature
        ...
        if((digitalRead(TripPin) == HIGH)){ //digitalRead(LaserPin) == HIGH) || 
          txtLights = "Lights are on";
        }else{
          txtLights = "Lights are off";
        }
        
        LaserValue = digitalRead(TripPin);
        MotionValue = digitalRead(LaserPin);
        ...
        WiServer.print("</center>");
        WiServer.print("<center>");
        WiServer.print("Power Strip box Temperature Reading: ");
        WiServer.print(" Kelvin: ");
        WiServer.print(h);
        WiServer.print(" T\t");
        WiServer.print(" Celsius ");
        WiServer.print(t);
        WiServer.println(" *C");
        WiServer.print(" Fehrenhite ");
        WiServer.print(f);
        WiServer.println(" *F");
        WiServer.println("        ");
      ...
      //  WiServer.println("        ");
        ...
        WiServer.print("</center>");
        WiServer.print("<center>");
        WiServer.print("Digital line for turning on lights: ");
  ...
  if((analogRead(2)<350) && (analogRead(5) < 480)){
    digitalWrite(waterPin, HIGH); //coment out this because you need to turn on the Lights
         ...
         // mySerial.print('\n');
          ...
          digitalWrite(waterPin, LOW); //lightPin
         // mySerial.print("turn on 3");
         // mySerial.print('\n');
